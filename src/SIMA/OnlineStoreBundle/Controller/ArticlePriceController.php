...
class ArticlePriceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('articleprice/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('articleprice/new.html.twig', array(
    ...
    public function showAction(ArticlePrice $articlePrice)
    {
        ...
        return $this->render('articleprice/show.html.twig', array(
            'articlePrice' => $articlePrice,
    ...
    public function editAction(Request $request, ArticlePrice $articlePrice)
    {
        ...
        return $this->render('articleprice/edit.html.twig', array(
            'articlePrice' => $articlePrice,
